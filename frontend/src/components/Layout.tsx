import { BarChart3, Bell, Building2, CalendarDays, CalendarRange, ClipboardList, FolderKanban, KeyRound, ListChecks, LogOut, Menu, Moon, NotebookTabs, Shield, Sun, Tag, UserCircle2, Users, Workflow, X } from 'lucide-react'

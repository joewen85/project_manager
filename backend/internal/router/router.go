...
func New(cfg config.Config, h *handler.Handler) *gin.Engine {
	...
	authGroup.Use(middleware.JWT(cfg.JWTSecret, h.DB))
	{
		...
		reports := authGroup.Group("/reports")
		{
			...
			reports.GET("/:id/run", middleware.RequirePermission(h.DB, "reports.read"), h.RunSavedReport)
			reports.GET("/:id/export.csv", middleware.RequirePermission(h.DB, "reports.read"), h.ExportSavedReportCSV)
			reports.GET("/:id/subscription", middleware.RequirePermission(h.DB, "reports.read"), h.ReportSubscriptionDetail)
			reports.PUT("/:id/subscription", middleware.RequirePermission(h.DB, "reports.update"), h.UpsertReportSubscription)
			reports.DELETE("/:id/subscription", middleware.RequirePermission(h.DB, "reports.update"), h.DeleteReportSubscription)
			reports.POST("/:id/subscription/run", middleware.RequirePermission(h.DB, "reports.update"), h.RunReportSubscriptionNow)
		...
		ai := authGroup.Group("/ai")
		{
			...
			ai.POST("/register-analysis", middleware.RequirePermission(h.DB, "ai.read"), h.AIProjectRegisterAnalysis)
			ai.POST("/register-analysis/stream", middleware.RequirePermission(h.DB, "ai.read"), h.AIProjectRegisterAnalysisStream)
		...
		insights := authGroup.Group("/insights")
		{
			...
			insightReports := insights.Group("/reports")
			{
				...
				insightReports.GET("/:id/run", middleware.RequirePermission(h.DB, "reports.read"), h.RunSavedReport)
				insightReports.GET("/:id/export.csv", middleware.RequirePermission(h.DB, "reports.read"), h.ExportSavedReportCSV)
				insightReports.GET("/:id/subscription", middleware.RequirePermission(h.DB, "reports.read"), h.ReportSubscriptionDetail)
				insightReports.PUT("/:id/subscription", middleware.RequirePermission(h.DB, "reports.update"), h.UpsertReportSubscription)
				insightReports.DELETE("/:id/subscription", middleware.RequirePermission(h.DB, "reports.update"), h.DeleteReportSubscription)
				insightReports.POST("/:id/subscription/run", middleware.RequirePermission(h.DB, "reports.update"), h.RunReportSubscriptionNow)
			...
			insightAI := insights.Group("/ai")
			{
				...
				insightAI.POST("/register-analysis", middleware.RequirePermission(h.DB, "ai.read"), h.AIProjectRegisterAnalysis)
				insightAI.POST("/register-analysis/stream", middleware.RequirePermission(h.DB, "ai.read"), h.AIProjectRegisterAnalysisStream)
